...
let catalogoDeProdutos = {
    ...
    "produto-aguetonis-hamburguerx": {
        tipo: "lanche",
        nome: "HAMBÚRGUER",
        precoRiscado: 23.99,
        preco: 20.00,
        descricao: "Hambúrguer Clássico: Pão macio, hambúrguer caseiro 90g, mussarela, alface, tomate e maionese da casa.",
        ingredientes: ["Pão de Hambúrguer", "Hambúrguer Caseiro 90g", "Mussarela", "Presunto", "Ketchup", "Alface", "Maionese", "Tomate"],
        imagem: "imagens/lanches/hamburguerx.png",
        adicionais: [
    {
      nome: 'Catupiry',
      preco: 6.00,
